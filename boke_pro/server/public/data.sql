...
--
-- Host: 127.0.0.1
-- Generation Time: 2019-06-01 10:48:23
...
-- Database: `laptop`
--
CREATE DATABASE IF NOT EXISTS `laptop` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `laptop`;
...
CREATE TABLE `laptop_family` (
  ...
  `laptopCount` smallint(6) DEFAULT '2'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- 转存表中的数据 `laptop_family`
--

INSERT INTO `laptop_family` (`fid`, `fname`, `laptopCount`) VALUES
(10, '联想', 2),
(20, '戴尔', 2),
(30, '小米', 3),
(40, '华为', 2),
...
--
-- Indexes for table `laptop_family`
--
ALTER TABLE `laptop_family`
  ADD PRIMARY KEY (`fid`),
...
--
-- 使用表AUTO_INCREMENT `laptop_family`
--
ALTER TABLE `laptop_family`
...
--
-- 转存表中的数据 `pma__navigationhiding`
--

INSERT INTO `pma__navigationhiding` (`username`, `item_name`, `item_type`, `db_name`, `table_name`) VALUES
('root', 'user', 'table', 'mysql', '');
...
('root', '[{\"db\":\"exam\",\"table\":\"score\"},{\"db\":\"exam\",\"table\":\"student\"},{\"db\":\"xuezi\",\"table\":\"emp\"}]');
...
('root', '2019-05-07 01:35:24', '{\"lang\":\"zh_CN\",\"collation_connection\":\"utf8mb4_unicode_ci\",\"ThemeDefault\":\"pmahomme\"}');
...
INSERT INTO `todos` (`tid`, `tnote`, `tstate`) VALUES
(2, '1231354', 0);
...
CREATE TABLE `laptop` (
  ...
  `stockCount` smallint(6) DEFAULT NULL,
  `sheifTime` date DEFAULT NULL,
...
INSERT INTO `laptop` (`lid`, `title`, `price`, `stockCount`, `sheifTime`, `isIndex`) VALUES
(1, 'macbook PRO', '19999.99', 100, '2019-04-03', 0),
(2, 'ipad PRO', '3999.99', 200, '2019-04-03', 1),
(3, 'macbook air', '8000.99', 80, '2019-04-03', 1),
(4, 'ipad min', '3000.99', 300, '2019-04-03', 0),
(5, 'ipad min2', '3000.99', 300, '2019-04-03', 0),
(6, 'ipad min3', '3000.99', 300, '2019-04-03', 1),
(7, 'ipad min4', '3000.99', 300, '2019-04-03', 0);
...
(8, 'double', '21221', '64@qq.com', '33333', NULL, '44444', 1),
(13, 'aaaa', '123456', '64@qq.com', '12357', NULL, '12133', 0),
(16, 'double', '123456', '64@qq.com', NULL, NULL, NULL, NULL),
(17, 'double', '123456', '64@qq.com', NULL, NULL, NULL, NULL),
(18, 'double', '123456', '64@qq.com', NULL, NULL, NULL, NULL),
(25, 'aaaaaa', '123456', '123', '123', NULL, '12', 0);
